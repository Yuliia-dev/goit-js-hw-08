...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form");a.addEventListener("input",(0,e.default)(o,500)),a.addEventListener("submit",l);const r="feedback-form-state";let n={};function l(e){e.preventDefault();const t=e.target.elements,a=t.email.value,n=t.message.value;if(""===a||""===n)return alert("Все поля должны быть заполнены!");const l={email:a,message:n};console.log(l),e.target.reset(),localStorage.removeItem(r)}function o(e){n[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(n))}function s(){let e=localStorage.getItem(r);e&&(e=JSON.parse(e),Object.entries(e).forEach(([e,t])=>{n[e]=t,a.elements[e].value=t}))}s();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.e740e831.js.map