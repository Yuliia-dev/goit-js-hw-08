...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector(".feedback-form");r.addEventListener("input",(0,e.default)(n,500)),r.addEventListener("submit",o);const a="feedback-form-state";function o(e){e.preventDefault(),e.target.reset(),localStorage.removeItem(a)}function n(e){let t=localStorage.getItem(a);(t=t?JSON.parse(t):{})[e.target.name]=e.target.value,localStorage.setItem(a,JSON.stringify(t))}function l(){let e=localStorage.getItem(a);e&&(e=JSON.parse(e),Object.entries(e).forEach(([e,t])=>r.elements[e].value=t))}l();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.c626dc11.js.map